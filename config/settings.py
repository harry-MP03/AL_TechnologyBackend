...
SECRET_KEY = 'django-insecure-0ya8npmrlbtuxzk1+_q%e)0#+l+q!*nak+=9s+euv&g*!*&8a5'
...
# Muestra los correos electrónicos en la terminal en lugar de enviarlos por internet
...
# Configuración para habilitar el candado de seguridad en Swagger
SWAGGER_SETTINGS = {
    'SECURITY_DEFINITIONS': {
        'Bearer': {
            ...
            'name': 'Authorization',
            'in': 'header',
            'description': "Ingresa tu token en este formato: Bearer {tu_token_largo}"
        }
    }
}
